...
// =====================================================================
// ---------------------------- DATABASE --------------------------------
// Simple JSON-file "database". No external dependencies required.
// =====================================================================
const db = (() => {
  ...
  return { readAll, writeAll, insert, update, findById, remove, ensureFile };
})();

// =====================================================================
// ------------------------------ AUTH ------------------------------------
// Password hashing + simple session tokens stored in the sessions table.
// =====================================================================
const auth = (() => {
  ...
  function destroySession(token) {
    const sessions = db.readAll('sessions');
    db.writeAll('sessions', sessions.filter((s) => s.token !== token));
  }
  ...
  return { hashPassword, verifyPassword, createSession, getUserFromToken, destroySession, parseCookies };
})();
